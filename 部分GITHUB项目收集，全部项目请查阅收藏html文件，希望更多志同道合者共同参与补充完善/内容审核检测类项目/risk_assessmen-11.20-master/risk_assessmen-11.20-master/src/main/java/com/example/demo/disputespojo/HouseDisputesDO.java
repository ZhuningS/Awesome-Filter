...
public class HouseDisputesDO {
    ...
    public HouseDisputesDO() {
    }

    public HouseDisputesDO(int previousyearturnnumber, int casetotal, int majorcases, int activerights, int totalamount, int railwaylawyers, int legalAdviseAgents, int externallawyers, int casesclosed, int arbitrationsfinished, int mediationcase, int firsttrialnumber, int secondtrialnumber, int successfulcases, int recoverreducelosses, int compensationamount) {
