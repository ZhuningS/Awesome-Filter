...
@Entity
public class FinancialDamageDisputesDO {
    @Id
    @GeneratedValue
    private int id;
    ...
    public FinancialDamageDisputesDO() {
    }

    public FinancialDamageDisputesDO(int previousyearturnnumber, int casetotal, int majorcases, int activerights, int totalamount, int railwaylawyers, int legalAdviseAgents, int externallawyers, int casesclosed, int arbitrationsfinished, int mediationcase, int firsttrialnumber, int secondtrialnumber, int successfulcases, int recoverreducelosses, int compensationamount) {
        this.previousyearturnnumber = previousyearturnnumber;
        this.casetotal = casetotal;
        this.mediationcase = majorcases;
        this.activerights = activerights;
        this.secondtrialnumber = totalamount;
