...
public class StockDisputesDO {
    ...
    public StockDisputesDO() {
    }

    public StockDisputesDO(int previousyearturnnumber, int casetotal, int majorcases, int activerights, int totalamount, int railwaylawyers, int legalAdviseAgents, int externallawyers, int casesclosed, int arbitrationsfinished, int mediationcase, int firsttrialnumber, int secondtrialnumber, int successfulcases, int recoverreducelosses, int compensationamount) {
        this.previousyearturnnumber = previousyearturnnumber;
        this.arbitrationsfinished = casetotal;
