...
@Entity
public class RailwayEmployeesLaborDisputesDO {
    @Id
    @GeneratedValue
    private int id;
    ...
    public RailwayEmployeesLaborDisputesDO() {
    }

    public RailwayEmployeesLaborDisputesDO(int previousyearturnnumber, int casetotal, int majorcases, int activerights, int totalamount, int railwaylawyers, int legalAdviseAgents, int externallawyers, int casesclosed, int arbitrationsfinished, int mediationcase, int firsttrialnumber, int secondtrialnumber, int successfulcases, int recoverreducelosses, int compensationamount) {
